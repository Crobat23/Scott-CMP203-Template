...
public:
    ...
    inline UINT64 GetRequiredIntermediateSize1(
        _In_ ID3D12Resource* pDestinationResource,
        _In_range_(0, D3D12_REQ_SUBRESOURCES) UINT FirstSubresource,
        _In_range_(0, D3D12_REQ_SUBRESOURCES - FirstSubresource) UINT NumSubresources) noexcept
    {
        ID3D12Resource2* Resource2{};
        pDestinationResource->QueryInterface(&Resource2);

        if (Resource2)
        {
#if defined(_MSC_VER) || !defined(_WIN32)
            auto Desc1 = Resource2->GetDesc1();
#else
            D3D12_RESOURCE_DESC tmpDesc;
            auto& Desc1 = *Resource2->GetDesc1(&tmpDesc);
#endif
            ...
            Desc1.Alignment = 0;
            pDevice->GetCopyableFootprints1(&Desc1, FirstSubresource, NumSubresources, 0, nullptr, nullptr, nullptr, &RequiredSize);
            pDevice->Release();
    ...
    inline UINT64 UpdateSubresources1(
        ...
        uint32_t numSubresources)
    {
        ...
        const UINT64 uploadSize = GetRequiredIntermediateSize1(
            resource,
        ...
        UpdateSubresources1(mList.Get(), resource, scratchResource.Get(), 0, subresourceIndexStart, numSubresources,
